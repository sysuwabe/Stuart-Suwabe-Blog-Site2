...
From all of this analysis, if I were to model the data sets, I would probably remove Los Angeles entirely. As an outlier, it would skew the data into its favor. 
