...
I've seen it for myself. Volunteering every Friday at a food pantry in Yuba County, food insecurity is no small matter. We've been getting more newcomers to the pantry by the week, and all of them thankful for what we give them, even if it isn't much. To me, food stamps and governmental aid can only go so far. If there were ways to go about lessening the blow for ourselves, whether it be by our own power or the local lawmakers, then the better we could be. 
...
It is from this data that the main output of this analysis, the food insecurity 
...
From what we could gather via linear regression, low poverty is the clear deciding factor in the food insecurity percentage, which makes sense. While the other factors are rather minuscule in comparison, there are a few details to note: notably there is a small correlation with the number of people in poverty that use public transportation. 
