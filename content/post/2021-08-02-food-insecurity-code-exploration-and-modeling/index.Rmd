...
```{r}
LAfoodin %>% ggplot(aes(year,secure_meal_value)) + geom_point() + ggtitle("Price of a meal in Los Angeles county increases over time") + xlab("year over time") + ylab("food insecurity percentage")
```
