---
title: 'Food Insecurity: How to tackle it'
author: R package build
date: '2021-08-04'
slug: food-insecurity-how-to-tackle-it
categories:
  - R
tags:
  - R
...
In the city of Marysville, every Friday morning at 10:00am, the First Presbyterian Church of Marysville opens up access to their food pantry. Alongside the wall of the tiny outlet, around the corner of the connected building, people both young and old, some with children, some with carts to hold their balance and their bags, all wait in line, all to receive their weekly groceries, the food they cannot reliably get on their own. After filling out a form, circling what food they would like from inside, they would be allowed, one at a time, into the small roped-off area, where they would fill up their bags and carts with produce graciously donated by the Yuba-Sutter Food Bank. 
...
It doesn't need to be said that the pandemic has made everyone suffer. Complaints about vaccines and mandatory masks aside, there was so much loss during the high times of COVID-19. Many people lost their lives, many businesses had to close, hopefully for a temporary amount of time, many public facilities and entertainment spots like libraries, museums, and gyms all shutting their doors, forcing the populace into their homes, provided they had one. But it is only during this time, that the people of the United States were truly exposed to the troubles of food insecurity. 
...
![](images/Decreasing food insecurity percentage.pdf)
Find the data here. 
...
The data results in a number of different ideas to look into to help curb food insecurity in the long run. The first would be to focus on children. Among all the models run, the suffering of the children within California remain as important to the food insecurity rate and the population of people that suffer from it. And while the USDA has put lots of funding into its many programs, some aimed at kids, there needs to be a shift towards children in need. They are the next generation, and have the potential to make our lives better, but they need to get to the point in their lives where they can use that potential first. 

Those that use public transportation are seen as important in the more numerical data sets, probably due to higher populated areas having more options for it. For these areas, perhaps it would be important to look into public transportation bills and laws. Offering more free (or lower-paying) options for transportation at expense of the state would help ease the burden of food insecurity. 

Looking at schooling, having your highest level of education being graduating high school can help lower the food insecurity rate, though it can help raise the number of people who become food insecure. In this sense, I think it clear that getting more people into college would greatly help them with job opportunities so they may be able to obtain jobs that provide for themselves. As a suggestion, perhaps there should be an increased outcry for lower tuition to colleges. Other countries have free tuition, so why not the United States? 

Finally, with the more population-driven data set, the minimum budget for food that the government could provide is a somewhat significant statistic, where with an increase in the budget, there would be a less amount of the population that would suffer from food insecurity. To me, this has a very simple solution: less money should go into food programs and more should go into the other parts of daily life, like schooling or public transportation. 
...
From more public transportation to more accessible schooling, and a focus on the children at hand, simply tackling the issue directly can only go so far. Helping alleviate other issues in society and people's daily lives will indirectly help them with their food issues. 

All that said, my analysis was not perfect. The pantry data that I scraped together is far from accurate, since there exists no full compilation of all pantry data in California. As well, I did remove one county from the data set that I saw as an outlier: Los Angeles County. I didn't want to remove more, but perhaps I should have looked into them more. As well, due to the pandemic, I have been unable to get any concrete amount of data from 2020 and 2021, forcing me to utilize 2019 data. While it's not too big of an issue, it would be nice to work with more current data. 

That said, I think there are multiple roads to take to tackle this problem. The main idea is this: while governmental food aid does indeed help, tackling other sectors of society like transportation and schooling would help curb food insecurity in the long run. 
